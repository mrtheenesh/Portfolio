...
const projects = [
  ...
  { 
    title: "REST API + React", 
    desc: "Basic full-stack integration",  
  ...
  { 
    ...
    desc: "AWS EC2 & hMail configuration",  
    img: "/techstack/awsec2_logo.svg" 
  },
  { 
    title: "AI Chatbot", 
    desc: "Local RAG model using FAISS", 
...
export default function Portfolio() {
  ...
  return (
    <section
      id="portfolio"
      className="text-white min-h-screen relative pt-20"
      >
      ...
      <Tabs.Root defaultValue="tech" className="w-full max-w-[1000px] mx-auto relative z-10" onValueChange={handleTabChange}>
        {/* ====== Tabs Header ====== */}
        ...
        <Tabs.Content value="tech">
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-8 px-6">
          ...
          <div
            ...
            {/* Card */}
            <div
              className="relative p-6 rounded-2xl bg-slate-800/50 hover:bg-slate-700/50
        ...
        <Tabs.Content value="projects">
          ...
          <div
            ...
            className="relative group"
          >
            {/* Neon Glow Background (hidden until hover) */}
            <div
              className="absolute inset-0 rounded-xl bg-gradient-to-r from-blue-200 via-pink-300 to-blue-500
                        opacity-0 group-hover:opacity-30 blur-xl transition duration-500"
            ></div>
