...
const skills = [
  { name: "Django", icon: <Code />, level: 83 },
  { name: "Python", icon: <Code />, level: 80 },
  { name: "HTML & CSS", icon: <Code />, level: 80 },
  { name: "React & Tailwind", icon: <Code />, level: 60 },
  { name: "JavaScript", icon: <Code />, level: 60 },
  { name: "Vite", icon: <Code />, level: 60 },
  { name: "SQL & PostgreSQL", icon: <Database />, level: 65 },
  { name: "Vercel (Deployment)", icon: <Cloud />, level: 50 },
  { name: "Cloud (EC2, Google Drive)", icon: <Cloud />, level: 35 },
];
